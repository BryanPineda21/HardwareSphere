          ...
          {isOwnProfile && onPinToggle && (
            ...
            >
              {project.isPinned ? (
                ...
                <Pin className="h-4 w-4 text-muted-foreground group-hover:text-foreground" />
              )}
            </Button>
          )}
          {isOwnProfile && (
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    your project and remove its data from our servers.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button
                size="icon"
                variant="secondary"
                className="h-8 w-8 rounded-full bg-black/40 text-white hover:bg-red-500/70"
                title="Delete project"
              >
                <Trash2 className="h-4 w-4" />
              </Button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {" "}
                  {formatFirestoreTimestamp(project.createdAt)} ago
                </p>
              </div>
            </div>
          </CardContent>
